...
## Group Leader
This was among my favorite projects so far. While certainly challenging, it was indeed exciting once we were able to achieve successful execution. I performed some further research immediately after the lecture for this module and was able to find an interactive tutorial that made the reconstruction of the BWT very easy to perform, and this helped significantly with a lot of our challenges, as we all felt this was the most difficult aspect of the lecture to grasp. I was actually amazed that similar letters grouped that way after lexicographic ordering, and that only one triangular half of the matrix needed to be saved to reconstruct the original sequence. The virtually unlimited applications of this algorithm are what make it so satisfying to have learned, and I truly hope to have the opportunity to implement this in my professional endeavors. While I had worked with Chantera previously, the dynamics were markedly different for many reasons, most notably, our roles were reversed and it was the very first project of the semester. For that project, it seemed like there was a lot of pressure for Chantera at that time to understand how to set up the GitHub repo according to specification, so having the opportunity to work together again and be more collaborative on the algorithm was a great experience to me because she is very knowledgeable about coding and I feel like I learned a great deal from her. This was my first time working with Marcos, and I was really excited about that as well because I had seen the exceptional quality of his work from conducting peer reviews. Marcos has significant strengths where I am weak- thinking from a programming and algorithmic perspective rather than biological, and I truly learned a lot from having the opportunity to do this project with him. Ultimately, we were able to agree on an implementation that executes successfully and that is a strong representation of each of our contributions, and I am very proud of our final version.
